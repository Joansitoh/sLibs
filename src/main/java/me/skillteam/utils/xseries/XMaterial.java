...
public enum XMaterial {
    ...
    static {
        if (Data.ISFLAT) {
            // It's not needed at all if it's the newer version. We can saveData some memory.
            DUPLICATED = null;
        } else {
     ...
     * to findData the old material name with its data value using a cached search for optimization.
     *
    ...
    /**
     * <b>XMaterial Paradox (Duplication Check)</b>
     * Checks if the material hasData any duplicates.
     * <p>
     * <b>Example:</b>
     ...
     * Manually parses the duplicated materials to findData the exact material based on the server version.
    ...
    /**
     * Checks if an item hasData the same material (and data value on older versions).
     *
